...
(function ($) {
    ...
    class $bog_klik_player extends $giper_baza_dict.with({
        Score: $giper_baza_atom_real,
        Name: $giper_baza_atom_text,
    }) {
    }
    $.$bog_klik_player = $bog_klik_player;
    let _players_dict_class = null;
    function $bog_klik_players_dict_class() {
        if (!_players_dict_class)
            _players_dict_class = $giper_baza_dict_to($bog_klik_player);
        return _players_dict_class;
    }
    $.$bog_klik_players_dict_class = $bog_klik_players_dict_class;
    /** Тонкий враппер над глобом + url-arg. Методы возвращающие ленды/pawn — БЕЗ $mol_mem. */
    class $bog_klik_store extends $mol_object {
        glob() {
...
;
	($.$bog_klik_play) = class $bog_klik_play extends ($.$mol_page) {
		Intro(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.$.$mol_locale.text("$bog_klik_play_Intro_text")));
			return obj;
		}
		create_click(next){
			if(next !== undefined) return next;
		...
		Create(){
			...
			(obj.sub) = () => (["Создать сессию"]);
			return obj;
		}
		start_block(){
			return [(this.Intro()), (this.Create())];
		}
		Start_block(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.start_block()));
			return obj;
		}
		name(next){
			if(next !== undefined) return next;
		...
		Name_field(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_klik_play_Name_field_hint")));
		...
		Tick_row(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_klik_play_Tick_row_hint")));
			(obj.value) = (next) => ((this.tick_ms(next)));
			return obj;
		}
		per_tick(next){
			if(next !== undefined) return next;
		...
		Per_tick_row(){
			const obj = new this.$.$mol_number();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_klik_play_Per_tick_row_hint")));
			(obj.value) = (next) => ((this.per_tick(next)));
			return obj;
		}
		Params(){
			const obj = new this.$.$mol_list();
		...
		Auto(){
			...
			(obj.checked) = (next) => ((this.auto_click(next)));
			(obj.label) = () => (["Автокликер"]);
			return obj;
		}
		game_block(){
			return [
		...
		Game_block(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.game_block()));
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$bog_klik_play_title"));
		}
		store(){
			const obj = new this.$.$bog_klik_store();
			return obj;
		}
		body(){
			return [(this.Start_block()), (this.Game_block())];
		}
	};
	($mol_mem(($.$bog_klik_play.prototype), "Intro"));
	($mol_mem(($.$bog_klik_play.prototype), "create_click"));
	($mol_mem(($.$bog_klik_play.prototype), "Create"));
	($mol_mem(($.$bog_klik_play.prototype), "Start_block"));
	($mol_mem(($.$bog_klik_play.prototype), "name"));
	($mol_mem(($.$bog_klik_play.prototype), "Name_field"));
	($mol_mem(($.$bog_klik_play.prototype), "Score_row"));
	($mol_mem(($.$bog_klik_play.prototype), "Share_row"));
	($mol_mem(($.$bog_klik_play.prototype), "Share_link"));
	($mol_mem(($.$bog_klik_play.prototype), "tick_ms"));
	($mol_mem(($.$bog_klik_play.prototype), "Tick_row"));
	($mol_mem(($.$bog_klik_play.prototype), "per_tick"));
	($mol_mem(($.$bog_klik_play.prototype), "Per_tick_row"));
	($mol_mem(($.$bog_klik_play.prototype), "Params"));
	($mol_mem(($.$bog_klik_play.prototype), "click"));
	($mol_mem(($.$bog_klik_play.prototype), "Click"));
	($mol_mem(($.$bog_klik_play.prototype), "auto_click"));
	($mol_mem(($.$bog_klik_play.prototype), "Auto"));
	($mol_mem(($.$bog_klik_play.prototype), "Game_block"));
	($mol_mem(($.$bog_klik_play.prototype), "store"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_klik_play extends $.$bog_klik_play {
            session_link() {
        ...
        __decorate([
            $mol_mem
        ], $bog_klik_play.prototype, "score", null);
        __decorate([
            $mol_mem
        ], $bog_klik_play.prototype, "name", null);
        __decorate([
            $mol_action
        ], $bog_klik_play.prototype, "click", null);
        __decorate([
            $mol_action
        ], $bog_klik_play.prototype, "create_click", null);
        __decorate([
            $mol_mem
        ], $bog_klik_play.prototype, "start_block", null);
        __decorate([
            $mol_mem
        ], $bog_klik_play.prototype, "game_block", null);
        __decorate([
            $mol_mem
        ], $bog_klik_play.prototype, "auto_tick", null);
        $$.$bog_klik_play = $bog_klik_play;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$bog_klik_board) = class $bog_klik_board extends ($.$mol_page) {
		total_title(){
			return "Игроков: 0";
		}
		Total(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.total_title()));
			return obj;
		}
		rows(){
			return [];
		...
		Score(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.player_score(id))]);
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$bog_klik_board_title"));
		}
		store(){
			const obj = new this.$.$bog_klik_store();
			return obj;
	...
	($mol_mem(($.$bog_klik_board.prototype), "Total"));
	($mol_mem(($.$bog_klik_board.prototype), "List"));
	($mol_mem_key(($.$bog_klik_board.prototype), "Rank"));
	($mol_mem_key(($.$bog_klik_board.prototype), "Name"));
	($mol_mem_key(($.$bog_klik_board.prototype), "Score"));
	($mol_mem(($.$bog_klik_board.prototype), "store"));
	($mol_mem_key(($.$bog_klik_board.prototype), "Row"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_klik_board extends $.$bog_klik_board {
            players_dict() {
                return this.store().players_dict();
            }
            player_keys() {
        ...
        __decorate([
            $mol_mem
        ], $bog_klik_board.prototype, "player_keys", null);
        __decorate([
            $mol_mem
        ], $bog_klik_board.prototype, "entries_sorted", null);
        __decorate([
            $mol_mem
        ], $bog_klik_board.prototype, "rows", null);
        $$.$bog_klik_board = $bog_klik_board;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_klik_bench) = class $bog_klik_bench extends ($.$mol_page) {
		Count_label(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_klik_bench_Count_label_title")));
			return obj;
		}
		bots_count(next){
			if(next !== undefined) return next;
		...
		Count_field(){
			const obj = new this.$.$mol_number();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_klik_bench_Count_field_hint")));
			(obj.value) = (next) => ((this.bots_count(next)));
			return obj;
		}
		Count_row(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Count_label()), (this.Count_field())]);
			return obj;
		}
		Tick_label(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_klik_bench_Tick_label_title")));
			return obj;
		}
		bot_tick_ms(next){
			if(next !== undefined) return next;
		...
		Tick_field(){
			const obj = new this.$.$mol_number();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_klik_bench_Tick_field_hint")));
			(obj.value) = (next) => ((this.bot_tick_ms(next)));
			return obj;
		}
		Tick_row(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Tick_label()), (this.Tick_field())]);
			return obj;
		}
		Per_label(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_klik_bench_Per_label_title")));
			return obj;
		}
		bot_per_tick(next){
			if(next !== undefined) return next;
		...
		Per_field(){
			const obj = new this.$.$mol_number();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_klik_bench_Per_field_hint")));
			(obj.value) = (next) => ((this.bot_per_tick(next)));
			return obj;
		}
		Per_row(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Per_label()), (this.Per_field())]);
			return obj;
		}
		Params(){
			const obj = new this.$.$mol_list();
		...
		Writes(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.writes_title()));
			return obj;
		}
		latency_title(){
			return "Длительность тика, мс: 0";
		}
		Latency(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.latency_title()));
			return obj;
		}
		Metrics(){
			const obj = new this.$.$mol_list();
		...
		title(){
			return (this.$.$mol_locale.text("$bog_klik_bench_title"));
		}
		store(){
			const obj = new this.$.$bog_klik_store();
			return obj;
	...
	($mol_mem(($.$bog_klik_bench.prototype), "Count_label"));
	($mol_mem(($.$bog_klik_bench.prototype), "bots_count"));
	($mol_mem(($.$bog_klik_bench.prototype), "Count_field"));
	($mol_mem(($.$bog_klik_bench.prototype), "Count_row"));
	($mol_mem(($.$bog_klik_bench.prototype), "Tick_label"));
	($mol_mem(($.$bog_klik_bench.prototype), "bot_tick_ms"));
	($mol_mem(($.$bog_klik_bench.prototype), "Tick_field"));
	($mol_mem(($.$bog_klik_bench.prototype), "Tick_row"));
	($mol_mem(($.$bog_klik_bench.prototype), "Per_label"));
	($mol_mem(($.$bog_klik_bench.prototype), "bot_per_tick"));
	($mol_mem(($.$bog_klik_bench.prototype), "Per_field"));
	($mol_mem(($.$bog_klik_bench.prototype), "Per_row"));
	($mol_mem(($.$bog_klik_bench.prototype), "Params"));
	($mol_mem(($.$bog_klik_bench.prototype), "running"));
	($mol_mem(($.$bog_klik_bench.prototype), "Toggle"));
	($mol_mem(($.$bog_klik_bench.prototype), "Ops"));
	($mol_mem(($.$bog_klik_bench.prototype), "Writes"));
	($mol_mem(($.$bog_klik_bench.prototype), "Latency"));
	($mol_mem(($.$bog_klik_bench.prototype), "Metrics"));
	($mol_mem(($.$bog_klik_bench.prototype), "store"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_klik_bench extends $.$bog_klik_bench {
            players_dict() {
                return this.store().players_dict();
            }
            bot_key(i) {
            ...
            bot_indexes() {
                if (!this.running())
                    return [];
                const out = [];
                for (let i = 0; i < this.bots_count(); i++)
                    out.push(i);
                return out;
            }
            ...
            tick() {
                ...
                for (const i of this.bot_indexes()) {
                    ...
                    if (!name)
                        player.Name('auto')?.val(this.bot_key(i));
                    writes++;
                }
        ...
        __decorate([
            $mol_mem
        ], $bog_klik_bench.prototype, "bot_indexes", null);
        __decorate([
            $mol_mem
        ], $bog_klik_bench.prototype, "tick", null);
        __decorate([
            $mol_mem
        ], $bog_klik_bench.prototype, "ops_count", null);
        __decorate([
            $mol_mem
        ], $bog_klik_bench.prototype, "writes_total", null);
        __decorate([
            $mol_mem
        ], $bog_klik_bench.prototype, "latency_ms", null);
        $$.$bog_klik_bench = $bog_klik_bench;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_klik_app) = class $bog_klik_app extends ($.$mol_page) {
		Play(){
			const obj = new this.$.$bog_klik_play();
			return obj;
		}
		Board(){
			const obj = new this.$.$bog_klik_board();
			return obj;
		}
		Bench(){
			const obj = new this.$.$bog_klik_bench();
			return obj;
		}
		screen(next){
			if(next !== undefined) return next;
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/b-on-g/klik");
			return obj;
		}
		Status(){
		...
		title(){
			return (this.$.$mol_locale.text("$bog_klik_app_title"));
		}
		pages(){
			return {
				"play": (this.Play()), 
	...
	($mol_mem(($.$bog_klik_app.prototype), "Play"));
	($mol_mem(($.$bog_klik_app.prototype), "Board"));
	($mol_mem(($.$bog_klik_app.prototype), "Bench"));
	($mol_mem(($.$bog_klik_app.prototype), "screen"));
	($mol_mem(($.$bog_klik_app.prototype), "Sources"));
	($mol_mem(($.$bog_klik_app.prototype), "Status"));
	($mol_mem(($.$bog_klik_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_klik_app.prototype), "Theme"));
	($mol_mem(($.$bog_klik_app.prototype), "Navbar"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $bog_klik_app extends $.$bog_klik_app {
            screen(next) {
        ...
        __decorate([
            $mol_mem
        ], $bog_klik_app.prototype, "screen", null);
        __decorate([
            $mol_mem
        ], $bog_klik_app.prototype, "screen_body", null);
        $$.$bog_klik_app = $bog_klik_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
